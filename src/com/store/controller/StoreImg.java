...
/**
 * Servlet implementation class StoreImg
 */
		...
		try {
			...
			if (index.equals("0")) {
					rs = stmt.executeQuery(
						"SELECT win_id_pic FROM store WHERE store_no='"+store_no+"'");
			...
			if (rs.next()) {
				...
				InputStream in = getServletContext().getResourceAsStream(req.getContextPath()+"/res/BackEnd/NoData/nopic.jpg");
