        ...
        <div class="right col-xs-10">
          <div class="col-xs-12 right_top"><img src="<%=request.getContextPath()%>/BackEnd/res/images/bear.jpg" alt="">
            ...
            <ul class="dropdown-menu">
              <li><a>10項檢舉未處理</a></li>
              <li><a href="act.html">10項活動未審核</a></li>
          ...
          <div class="col-xs-12 right_bottom">
            ...
            <div class="col-xs-3">
              <div class="report"><a class="fa fa-futbol-o" href="act.html"></a>
                <h2><a href="act.html">10項活動未審核</a></h2>
              </div>
            </div>
            <div class="col-xs-3">
              <div class="report"><a class="fa fa-address-card-o" href=""></a>
                <h2><a href="">10項廠商會員申請未審核</a></h2>
              </div>
            </div>
            <div class="col-xs-3">
              <div class="report"><a class="fa fa-gift" href="<%=request.getContextPath()%>/BackEnd/gift/convert_gift.jsp" ></a>
                <h2><a href="<%=request.getContextPath()%>/BackEnd/gift/convert_gift.jsp" >10項兌換贈品申請</a></h2>
              </div>
            </div>
          </div>
        </div>
